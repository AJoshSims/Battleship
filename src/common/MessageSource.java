...
* observer pattern. This class should be extended by classes that want to 
* deliver messages to some set of interested parties. These &quot;interested 
* parties&quot; are decoupled from the implementation of this class &ndash; 
* those classes must implement the <code>MessageListener</code> interface.
*
